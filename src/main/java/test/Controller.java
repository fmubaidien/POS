...
public class Controller {
        ...
        public JSONObject index(@RequestBody String preText) {
                ...
                String text = preText;
                String out= "";
                JSONObject objFull = new JSONObject(); //encloses both objects


                JSONObject obj = new JSONObject(); //grouped
                JSONObject obj2 = new JSONObject(); //not grouped
                ...
                CoreDocument coreDocument2 = new CoreDocument(text);

                stanfordCoreNLP.annotate(coreDocument);
                stanfordCoreNLP.annotate(coreDocument2);

                List<CoreLabel> coreLabelList = coreDocument.tokens();

                List<CoreLabel> coreLabelList2 = coreDocument2.tokens();



                for(CoreLabel coreLabel2 :coreLabelList2) {
                        String poss = coreLabel2.get(CoreAnnotations.PartOfSpeechAnnotation.class);
                        obj2.put(coreLabel2.originalText(), poss);
                ...
                objFull.put("Normal:",obj2);
                objFull.put("Grouped:",obj);
